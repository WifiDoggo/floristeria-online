...
<!--Menú Principal-->
    ...
    <nav class="nav flex-column">
        <a class="nav-link disabled" aria-current="page" href="#" aria-disabled="true"><h5>Administrar Objetos</h5></a>
        <a class="nav-link disabled" aria-current="page" href="#" aria-disabled="true"><h5>Administrar Usuarios</h5></a>
        <a class="nav-link" href="autoria.php"><h5>Autoría de Compras</h5></a>
