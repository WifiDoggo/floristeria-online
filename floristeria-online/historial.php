...
if (!isset($_SESSION['logged_in']) || !$_SESSION['logged_in']) {
  ...
  header('Location: registro/acceso.php');
  exit;
}
...
$sql = "SELECT id_factura, nombre_productos, precio, cantidad, total FROM facturas WHERE id_user = $id_user";
...
<head>
    ...
    <title>Historial de compras | Floristería Petalia</title>
</head>
...
<h2 class="text-success" id="subtitulo">Historial de Compras</h2>
    <div class="container">
